...
var mediasoupClient = (() => {
  ...
  var require_ortc = __commonJS({
    "node_modules/mediasoup-client/lib/ortc.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.validateAndNormalizeRtpCapabilities =
        validateAndNormalizeRtpCapabilities;
      exports.validateAndNormalizeRtpParameters =
        validateAndNormalizeRtpParameters;
      exports.validateAndNormalizeSctpStreamParameters =
      ...
      function getExtendedRtpCapabilities(
        ...
        if (preferLocalCodecsOrder) {
          for (const localCodec of (_a = localCaps.codecs) != null ? _a : []) {
            ...
            const matchingRemoteCodec = (
              (_b = remoteCaps.codecs) != null ? _b : []
            ).find((remoteCodec) =>
            ...
            const extendedCodec = {
              ...
              remoteParameters:
                (_d = matchingRemoteCodec.parameters) != null ? _d : {},
              rtcpFeedback: reduceRtcpFeedback(localCodec, matchingRemoteCodec),
            };
            extendedRtpCapabilities.codecs.push(extendedCodec);
          }
        } else {
          for (const remoteCodec of (_e = remoteCaps.codecs) != null
            ? _e
            : []) {
            if (isRtxCodec(remoteCodec)) {
              continue;
            }
            const matchingLocalCodec = (
              (_f = localCaps.codecs) != null ? _f : []
            ).find((localCodec) =>
            ...
            const extendedCodec = {
              ...
              remoteRtxPayloadType: void 0,
              localParameters:
                (_g = matchingLocalCodec.parameters) != null ? _g : {},
        ...
        for (const extendedCodec of extendedRtpCapabilities.codecs) {
          const matchingLocalRtxCodec = localCaps.codecs.find((localCodec) => {
            ...
            return (
              ...
              ((_a2 = localCodec.parameters) == null ? void 0 : _a2["apt"]) ===
          ...
          const matchingRemoteRtxCodec = remoteCaps.codecs.find(
            (remoteCodec) => {
              ...
              return (
                ...
                ((_a2 = remoteCodec.parameters) == null
                  ? void 0
                  : _a2["apt"]) === extendedCodec.remotePayloadType
              );
            }
          );
        ...
        for (const remoteExt of remoteCaps.headerExtensions) {
          ...
          const extendedExt = {
            ...
            encrypt:
              (_i = matchingLocalExt.preferredEncrypt) != null ? _i : false,
            direction: "sendrecv",
          };
      ...
      function getRecvRtpCapabilities(extendedRtpCapabilities) {
        ...
        for (const extendedExtension of extendedRtpCapabilities.headerExtensions) {
          ...
          const ext = {
            ...
            preferredEncrypt:
              (_a = extendedExtension.encrypt) != null ? _a : false,
      ...
      function getSendingRemoteRtpParameters(kind, extendedRtpCapabilities) {
        ...
        if (
          ...
          for (const codec of rtpParameters.codecs) {
            codec.rtcpFeedback = (
              (_b = codec.rtcpFeedback) != null ? _b : []
            ).filter((fb) => fb.type !== "transport-cc");
          }
        } else {
          for (const codec of rtpParameters.codecs) {
            codec.rtcpFeedback = (
              (_c = codec.rtcpFeedback) != null ? _c : []
            ).filter(
      ...
      function canSend(kind, rtpCapabilities) {
        var _a;
        return ((_a = rtpCapabilities.codecs) != null ? _a : []).some(
      ...
      function matchCodecs(
        ...
        switch (aMimeType) {
          case "video/h264": {
            if (strict) {
              const aPacketizationMode =
                (_a = aCodec.parameters["packetization-mode"]) != null ? _a : 0;
              const bPacketizationMode =
                (_b = bCodec.parameters["packetization-mode"]) != null ? _b : 0;
          ...
          case "video/vp9": {
            if (strict) {
              const aProfileId =
                (_c = aCodec.parameters["profile-id"]) != null ? _c : 0;
              const bProfileId =
                (_d = bCodec.parameters["profile-id"]) != null ? _d : 0;
      ...
      function reduceRtcpFeedback(codecA, codecB) {
        ...
        for (const aFb of (_a = codecA.rtcpFeedback) != null ? _a : []) {
          const matchingBFb = (
            (_b = codecB.rtcpFeedback) != null ? _b : []
          ).find(
            (bFb) =>
              bFb.type === aFb.type &&
        ...
        async push(task, name, options) {
          ...
          return new Promise((resolve, reject) => {
            if (
              ...
              (options == null
                ? void 0
                : options.removeOngoingTasksWithSameName)
            ) {
              for (const pendingTask2 of this.pendingTasks.values()) {
                if (pendingTask2.name === name) {
                  pendingTask2.reject(
                    new errors_1.AwaitQueueRemovedTaskError(),
                    {
      ...
      var Producer = class extends enhancedEvents_1.EnhancedEventEmitter {
        constructor({
          ...
          __publicField(
            this,
            "_observer",
            new enhancedEvents_1.EnhancedEventEmitter()
          );
          logger.debug("constructor()");
          this._id = id;
        ...
        handleDataChannel() {
          ...
          this._dataChannel.addEventListener("error", (event) => {
            ...
            const error =
              (_a = event.error) != null
                ? _a
                : new Error("unknown DataChannel error");
            if (
              ((_b = event.error) == null ? void 0 : _b.errorDetail) ===
              "sctp-failure"
            ) {
              logger.error(
                "DataChannel SCTP error [sctpCauseCode:%s]: %s",
                (_c = event.error) == null ? void 0 : _c.sctpCauseCode,
                event.error.message
              );
            } else {
      ...
      var Transport = class extends enhancedEvents_1.EnhancedEventEmitter {
        constructor({
          ...
          const clonedAdditionalSettings =
            (_a = utils.clone(additionalSettings)) != null ? _a : {};
          ...
          return this._awaitQueue
            .push(async () => {
              ...
              if (encodings && !Array.isArray(encodings)) {
                ...
                (encodings == null ? void 0 : encodings.length) === 0
              ) {
  ...
  var require_scalabilityModes = __commonJS({
    "node_modules/mediasoup-client/lib/scalabilityModes.js"(exports) {
      ...
      function parse(scalabilityMode) {
        const match = ScalabilityModeRegex.exec(
          scalabilityMode != null ? scalabilityMode : ""
        );
        if (match) {
          return {
    ...
    "node_modules/mediasoup-client/lib/handlers/sdp/MediaSection.js"(exports) {
      ...
      var AnswerMediaSection = class extends MediaSection {
            ...
            case "video": {
              ...
              for (const codec of answerRtpParameters.codecs) {
                ...
                const codecParameters =
                  (_a = utils.clone(codec.parameters)) != null ? _a : {};
                let codecRtcpFeedback =
                  (_b = utils.clone(codec.rtcpFeedback)) != null ? _b : [];
                if (codecOptions) {
                  const {
                    opusStereo,
                    opusFec,
              ...
              for (const ext of answerRtpParameters.headerExtensions) {
                const found = (
                  (_c = offerMediaObject.ext) != null ? _c : []
              ...
              if (offerMediaObject.simulcast) {
                ...
                for (const rid of (_d = offerMediaObject.rids) != null
                  ? _d
                  : []) {
                ...
                this._mediaObject.rids = [];
                for (const rid of (_e = offerMediaObject.rids) != null
                  ? _e
                  : []) {
                  if (rid.direction !== "send") {
                    continue;
        ...
        muxSimulcastStreams(encodings) {
          var _a, _b;
          if (
            !((_a = this._mediaObject.simulcast) == null ? void 0 : _a.list1)
          ) {
            return;
          }
          const layers = {};
          ...
          for (const simulcastStream of simulcastStreams) {
            for (const simulcastFormat of simulcastStream) {
              simulcastFormat.paused = !((_b = layers[simulcastFormat.scid]) ==
              null
                ? void 0
                : _b.active);
            }
    ...
    "node_modules/mediasoup-client/lib/handlers/sdp/commonUtils.js"(exports) {
        ...
        for (const m of sdpObject.media) {
          ...
          for (const fmtp of (_a = m.fmtp) != null ? _a : []) {
            ...
            if (
              parameters == null
                ? void 0
                : parameters.hasOwnProperty("profile-level-id")
            ) {
      ...
      function extractDtlsParameters({ sdpObject }) {
        ...
        if (!setup || !fingerprint) {
          const mediaObject = ((_a = sdpObject.media) != null ? _a : []).find(
            (m) => m.port !== 0
          );
          if (mediaObject) {
            setup = setup != null ? setup : mediaObject.setup;
            fingerprint =
              fingerprint != null ? fingerprint : mediaObject.fingerprint;
          }
        }
        if (!setup) {
      ...
      function getCname({ offerMediaObject }) {
        var _a;
        const ssrcCnameLine = (
          (_a = offerMediaObject.ssrcs) != null ? _a : []
      ...
      function applyCodecParameters({ offerRtpParameters, answerMediaObject }) {
        ...
        for (const codec of offerRtpParameters.codecs) {
          ...
          const rtp = ((_a = answerMediaObject.rtp) != null ? _a : []).find(
          ...
          answerMediaObject.fmtp =
            (_b = answerMediaObject.fmtp) != null ? _b : [];
          ...
          switch (mimeType) {
            case "audio/opus": {
              const spropStereo =
                (_c = codec.parameters) == null ? void 0 : _c["sprop-stereo"];
  ...
  var require_unifiedPlanUtils = __commonJS({
    "node_modules/mediasoup-client/lib/handlers/sdp/unifiedPlanUtils.js"(
      ...
      function getRtpEncodings({ offerMediaObject }) {
        ...
        for (const line of (_b = offerMediaObject.ssrcGroups) != null
          ? _b
          : []) {
      ...
      function addLegacySimulcast({ offerMediaObject, numStreams }) {
        ...
        const ssrcCnameLine = (
          (_c = offerMediaObject.ssrcs) != null ? _c : []
        ).find((line) => line.attribute === "cname");
        if (!ssrcCnameLine) {
  ...
  var require_utils2 = __commonJS({
    "node_modules/mediasoup-client/lib/handlers/ortc/utils.js"(exports) {
      ...
      function addNackSupportForOpus(rtpCapabilities) {
        ...
        for (const codec of (_a = rtpCapabilities.codecs) != null ? _a : []) {
          if (
            ...
            !((_b = codec.rtcpFeedback) == null
              ? void 0
              : _b.some((fb) => fb.type === "nack" && !fb.parameter))
          ) {
      ...
      function addHeaderExtensionSupport(rtpCapabilities, headerExtension) {
        var _a;
        let preferredId;
        const existingHeaderExtension =
          (_a = rtpCapabilities.headerExtensions) == null
            ? void 0
            : _a.find((exten) => exten.uri === headerExtension.uri);
    ...
    "node_modules/mediasoup-client/lib/handlers/Chrome111.js"(exports) {
      ...
      var Chrome111 = class _Chrome111 extends enhancedEvents_1.EnhancedEventEmitter {
            ...
            __spreadValues(
              {
                ...
                iceTransportPolicy:
                  iceTransportPolicy != null ? iceTransportPolicy : "all",
            ...
            getNativeRtpCapabilities: async () => {
              ...
              try {
                ...
                const nativeRtpCapabilities =
                  _Chrome111.getLocalRtpCapabilities(sdpObject);
        ...
        async send({
          ...
          if (!this._transportReady) {
            await this.setupTransport({
              localDtlsRole:
                (_a = this._forcedLocalDtlsRole) != null ? _a : "client",
              localSdpObject,
            });
          }
          if (
            headerExtensionOptions == null
              ? void 0
              : headerExtensionOptions.absCaptureTime
          ) {
            ...
            sdpCommonUtils.addHeaderExtension({
              ...
              headerExtensionId:
                sendingRemoteRtpParameters.headerExtensions.find(
                  (headerExtension) =>
                    headerExtension.uri ===
                    "http://www.webrtc.org/experiments/rtp-hdrext/abs-capture-time"
                ).id,
          ...
          sendingRtpParameters.msid = `${
            streamId != null ? streamId : this._sendStream.id
          } ${track.id}`;
          if (!encodings) {
        ...
        async setRtpEncodingParameters(localId, params) {
          ...
          const parameters = transceiver.sender.getParameters();
          parameters.encodings.forEach((encoding, idx) => {
            parameters.encodings[idx] = __spreadValues(
              __spreadValues({}, encoding),
              params
            );
          });
          await transceiver.sender.setParameters(parameters);
        ...
        async receive(optionsList) {
          ...
          for (const options of optionsList) {
            ...
            const localId =
              (_a = rtpParameters.mid) != null
                ? _a
                : String(this._mapMidTransceiver.size);
            ...
            this._remoteSdp.receive({
              ...
              streamId:
                (_d =
                  (_c = streamId != null ? streamId : msidStreamId) != null
                    ? _c
                    : (_b = rtpParameters.rtcp) == null
                    ? void 0
                    : _b.cname) != null
                  ? _d
                  : "-",
          ...
          if (!this._transportReady) {
            await this.setupTransport({
              localDtlsRole:
                (_e = this._forcedLocalDtlsRole) != null ? _e : "client",
              localSdpObject,
            });
          }
          logger.debug(
      ...
      var Chrome74 = class _Chrome74 extends enhancedEvents_1.EnhancedEventEmitter {
          ...
          return {
            ...
            getNativeRtpCapabilities: async () => {
              ...
              try {
                ...
                const sdpObject = sdpTransform.parse(offer.sdp);
                const nativeRtpCapabilities =
                  _Chrome74.getLocalRtpCapabilities(sdpObject);
                return nativeRtpCapabilities;
              } catch (error) {
                try {
                  pc == null ? void 0 : pc.close();
        ...
        async send({
          ...
          const layers = (0, scalabilityModes_1.parse)(
            (encodings != null ? encodings : [{}])[0].scalabilityMode
          );
          let offerMediaObject;
          if (
            (encodings == null ? void 0 : encodings.length) === 1 &&
    ...
    "node_modules/mediasoup-client/lib/handlers/Firefox120.js"(exports) {
      ...
      var Firefox120 = class _Firefox120 extends enhancedEvents_1.EnhancedEventEmitter {
          ...
          return {
            ...
            getNativeRtpCapabilities: async () => {
              ...
              try {
                ...
                const sdpObject = sdpTransform.parse(offer.sdp);
                const nativeRtpCapabilities =
                  _Firefox120.getLocalRtpCapabilities(sdpObject);
                return nativeRtpCapabilities;
              } catch (error) {
                try {
                  canvas.remove();
        ...
        async send({
          ...
          const nativeRtpCapabilities =
            _Firefox120.getLocalRtpCapabilities(localSdpObject);
          const sendExtendedRtpCapabilities =
            this._getSendExtendedRtpCapabilities(nativeRtpCapabilities);
          const sendingRtpParameters = ortc.getSendingRtpParameters(
            track.kind,
          ...
          return {
            ...
            getNativeRtpCapabilities: async () => {
              ...
              try {
                ...
                const sdpObject = sdpTransform.parse(offer.sdp);
                const nativeRtpCapabilities =
                  _Safari12.getLocalRtpCapabilities(sdpObject);
                return nativeRtpCapabilities;
              } catch (error) {
                try {
                  pc == null ? void 0 : pc.close();
          ...
          return {
            ...
            getNativeRtpCapabilities: async () => {
              ...
              try {
                ...
                const sdpObject = sdpTransform.parse(offer.sdp);
                const nativeRtpCapabilities =
                  _ReactNative106.getLocalRtpCapabilities(sdpObject);
                return nativeRtpCapabilities;
              } catch (error) {
                try {
                  pc == null ? void 0 : pc.close();
  ...
  var require_Device = __commonJS({
    "node_modules/mediasoup-client/lib/Device.js"(exports) {
            ...
            switch (handlerName) {
              ...
              case "ReactNative106": {
                this._handlerFactory =
                  ReactNative106_1.ReactNative106.createFactory();
                break;
              }
              default: {
      ...
      function getChromiumMajorVersion(userAgent, userAgentData) {
        ...
        if (userAgentData) {
          const chromiumBrand = (
            (_a = userAgentData.brands) != null ? _a : []
          ).find((b) => b.brand === "Chromium");
          if (chromiumBrand) {
        ...
        const match =
          userAgent == null
            ? void 0
            : userAgent.match(/\b(?:Chrome|Chromium)\/(\w+)/i);
      ...
      function getFirefoxMajorVersion(userAgent) {
        ...
        const match =
          userAgent == null ? void 0 : userAgent.match(/\bFirefox\/(\w+)/i);
        if (match == null ? void 0 : match[1]) {
          const majorVersion = Number(match[1]);
          logger.debug(
      ...
      function getIOSWebKitMajorVersion(userAgent) {
        ...
        const match =
          userAgent == null ? void 0 : userAgent.match(/AppleWebKit\/(\w+)/i);
        if (match == null ? void 0 : match[1]) {
          const majorVersion = Number(match[1]);
          logger.debug(
      ...
      function isIOS(userAgent, userAgentData) {
        logger.debug("isIOS()");
        if (
          (userAgentData == null ? void 0 : userAgentData.platform) === "iOS"
        ) {
          logger.debug(
      ...
      var _FakeMediaStreamTrack = class _FakeMediaStreamTrack extends FakeEventTarget_1.FakeEventTarget {
        constructor({
          ...
          __privateSet(
            this,
            _readyState,
            readyState != null ? readyState : "live"
          );
          __privateSet(
            this,
            _capabilities,
        ...
        set onenabledchange(handler) {
          if (__privateGet(this, _onenabledchange)) {
            this.removeEventListener(
              "enabledchange",
              __privateGet(this, _onenabledchange)
            );
          }
        ...
        clone({ id, data } = {}) {
          return new _FakeMediaStreamTrack({
            ...
            data:
              data != null
                ? data
                : (0, utils_1.clone)(__privateGet(this, _data)),
          });
        }
        getCapabilities() {
      ...
      var FakeHandler = class _FakeHandler extends enhancedEvents_1.EnhancedEventEmitter {
        constructor(
          ...
          __publicField(
            this,
            "_cname",
            `CNAME-${utils.generateRandomNumber()}`
          );
          // Default sending MediaStream id.
          __publicField(
            this,
            "_defaultSendStreamId",
        ...
        async send({ track, streamId, encodings, codecOptions, codec }) {
          ...
          const nativeRtpCapabilities = _FakeHandler.getLocalRtpCapabilities(
          ...
          sendingRtpParameters.msid = `${streamId != null ? streamId : "-"} ${
            track.id
          }`;
          if (!encodings) {
            encodings = [{}];
          ...
          sendingRtpParameters.msid = `${
            streamId != null ? streamId : this._defaultSendStreamId
          } ${track.id}`;
